...
function reserverBronze() {
  const { ajouterReservation, getHorairesDisponibles, estDisponible } = useReservations();
  ...
  const horairesDispoDate = selectedDate ? getHorairesDisponibles(selectedDate) : [];
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      ajouterReservation(selectedDate, selectedTime, 'Bronze'); 
      // Reset du formulaire
